    ...
    <div className='w-screen h-full flex flex-col justify-center items-center'>
      ...
      <form className='w-screen h-full lg:px-24 flex flex-col gap-3 m-8 items-center justify-center '>
            ...
            <div className='flex flex-col md:w-2/5 sm:w-3/5 w-4/5'>
              ...
              {!label.includes("description") ? (
                <input
                  type='text'
                  name={key}
                  className='border border-slate-900 rounded-md mb-2 h-8 w-full'
                />
              ) : (
                <textarea
                  name={key}
                  className='border border-slate-900 rounded-md mb-2 w-full'
                />
              )}
            </div>
          );
        ...
        <div className='md:w-2/5 sm:w-3/5 w-4/5 flex flex-row justify-start items-center '>
          <button>
            <button className='bg-slate-600 rounded-md sm:text-2xl text-xl sm:w-32 w-24 mr-1 sm:h-12 h-10 p-1 '>
              Cancel
            </button>
            <h3 className='sm:text-3xl text-xl inline-block mx-2'>/</h3>
            <button className='bg-green-500 rounded-lg sm:text-2xl text:xl sm:w-32 w-24 ml-1 sm:h-12 h-10 p-1'>
              Confirm
            </button>
          </button>
        </div>
